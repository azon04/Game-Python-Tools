...
class Project:
	...
	def Package(self, config, platform, bCompile, bPak, output_folder_name = ""):
...
if __name__ == "__main__":
	project = Project("E:\\Workspaces\\Unfolded\\Unfolded\\Unfolded.uproject")
	project.Build("Unfolded", "Win64", "Development", False)